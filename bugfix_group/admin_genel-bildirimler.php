...
$sql = "SELECT * FROM genel_bildirim ORDER BY id DESC";
...
function deactivateRecord(id) {
    if (confirm("Bu kaydı deaktif etmek istediğinize emin misiniz?")) {
        ...
        xhttp.open("POST", "../inc/post/admin/genel_deactivate_record.php", true);
...
function deleteRecord(id) {
    if (confirm("Bu kaydı silmek istediğinize emin misiniz?")) {
        ...
        xhttp.open("POST", "../inc/post/admin/genel_delete_record.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhttp.send("id=" + id);
    }
}
...
$(document).ready(function(){
    $('#addNewAddressForm').on('submit', function(){
        ...
        $.ajax({
            url: '../inc/post/admin/genel-duyuru-ekle.php', // change this to your file path
            type: 'post',
