...
<body>
  ...
  <section class="auth d-flex">
    <div class="auth-left bg-main-50 flex-center p-24">
      <img src="https://evoegitim.com/popgorsel/6569d8998c6061.jpg" alt="" />
    </div>
    <div class="auth-right py-40 px-24">
      <div class="auth-right__inner mx-auto w-100">
        ...
        <p class="text-gray-600 text-15 mb-32">Değerli velimiz sağlık ve huzur dolu bir gün dileriz.</p>
        <?php if(isset($_GET["error"])){ ?>
<p class="alert alert-danger">Değerli velimiz, email ve şifreniz ile giriş yapamadık. Lütfen bilgilerinizi kontrol ediniz.</p>
<?php } ?>

<?php if(isset($_GET["recover"])){ ?>
<p class="alert alert-success">Değerli velimiz, şifre yenileme talebiniz alındı. Lütfen telefon numaranıza gelen yeni şifreniz ile giriş yapınız</p>
<?php } ?>
        <form action="vbs/auth/login.php" method="POST">
          <div class="mb-24">
          ...
          <div class="mb-32 flex-between flex-wrap gap-8">
            ...
            <a href="vbs/forgot-password.php"
