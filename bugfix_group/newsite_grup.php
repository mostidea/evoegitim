...
function formatStartDate($start_date) {
    if (empty($start_date)) return 'Esnek';
...
<meta property="og:image" content="https://elements-resized.envatousercontent.com/envato-dam-assets-production/EVA/TRX/42/6b/5a/bc/7d/v1_E11/E11JM37.jpg?w=1600&cf_fit=scale-down&mark-alpha=18&mark=https%3A%2F%2Felements-assets.envato.com%2Fstatic%2Fwatermark4.png&q=85&format=auto&s=8dbe00b2cc5c4de8abb1db17801943b9b558b8f1f5bf6ece60bde512e3ed271c">
...
<body>
  ...
  <div class="breadcumb-wrapper" data-bg-src="https://elements-resized.envatousercontent.com/envato-dam-assets-production/EVA/TRX/bf/c7/e0/0b/17/v1_E10/E10AJVMR.JPG?w=1600&cf_fit=scale-down&mark-alpha=18&mark=https%3A%2F%2Felements-assets.envato.com%2Fstatic%2Fwatermark4.png&q=85&format=auto&s=85128b3cb2e1251574179bfd9837011b3823735bb8405f7890438e00a58acb6c" style="position: relative;">
            ...
            <form method="GET" action="" class="row g-3">
              ...
              <div class="col-md-3">
                <select name="level" class="form-select">
                  ...
                  <option value="LİSE" <?php echo ($level_filter == 'LİSE') ? 'selected' : ''; ?>>Lise</option>
                  <option value="ORTAOKUL" <?php echo ($level_filter == 'ORTAOKUL') ? 'selected' : ''; ?>>Ortaokul</option>
                </select>
              </div>
              <div class="col-md-4">
              ...
              <div class="course-style2">
                <div class="course-img">
                  <a href="grup-detay/<?php echo $slug; ?>">
                    <img class="w-100" src="<?php echo getGroupImage($group['image']); ?>" 
                         alt="<?php echo htmlspecialchars($group['title']); ?>" />
                  </a>
                  <span class="course-price"><?php echo $group['credit']*$group['weekly_lesson_count']; ?> Kredi</span>
                </div>
                <div class="course-content">
                  ...
                  <div class="course-meta">
                    ...
                    <span><i class="fas fa-clock"></i><?php echo $group['total_lesson_time']; ?> Saat</span>
                    <span><i class="far fa-calendar"></i><?php echo turkcetarih('j F Y H:i', $group['start_date']); ?></span>
                  </div>
                  <div class="course-footer">
                    <div class="course-teacher">
                      <a href="teacher-details.php?name=<?php echo createSlug($group['teacher_name'])."-".$group['id']; ?>" class="text-inherit">
                        <img src="<?php echo getTeacherPhoto($group['teacher_photo'], $group['teacher_gender']); ?>" 
              ...
              <ul>
                ...
                <?php if ($endPage < $totalPages): ?>
                  <?php if ($endPage < $totalPages - 1): ?>
                    <li><span>...</span></li>
                  <?php endif; ?>
                  <li><a href="?page=<?php echo $totalPages; ?><?php 
                    echo ($lesson_filter > 0) ? '&lesson=' . $lesson_filter : '';
                    echo !empty($level_filter) ? '&level=' . urlencode($level_filter) : '';
                    echo !empty($search) ? '&search=' . urlencode($search) : '';
